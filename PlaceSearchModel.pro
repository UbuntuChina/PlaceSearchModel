...
UBUNTU_TRANSLATION_DOMAIN="placesearchmodel.liu-xiao-guo"
...
aptest.commands = bash $$PWD/PlaceSearchModel/tests/autopilot/run
aptest.depends  = sub-PlaceSearchModel

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/PlaceSearchModel/tests/unit 
unittest.depends  = sub-PlaceSearchModel
